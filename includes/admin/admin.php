...
class StorePictureAdmin {
  ...
  function load_admin_style() {
    ...
    wp_enqueue_script('store-picture-modal');
		...
		/* vue */
		wp_register_script('vue', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/javascripts/vue.js', array(), STOREPICTURE_VERSION, true);
    ...
    wp_register_script('vue-carousel-3d', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/vueElementLibs/vue-carousel-3d.min.js', array('vue'), STOREPICTURE_VERSION, true);
		...
		/* ui-kit */
		wp_register_style('uikit', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/uikit/css/uikit.css', false, STOREPICTURE_VERSION);
    wp_enqueue_style('uikit');
		wp_register_script('uikit', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/uikit/js/uikit.min.js', array('jquery'), STOREPICTURE_VERSION, true);
    wp_enqueue_script('uikit');
		wp_register_script('uikit-icons', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/uikit/js/uikit-icons.min.js', array('jquery'), STOREPICTURE_VERSION, true);
    ...
    wp_register_script('nanoscroller', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/nanoscroller/jquery.nanoscroller.min.js', array('jquery'), STOREPICTURE_VERSION, true);
		...
		/* isotope */
		wp_register_script('isotope', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/javascripts/isotope.pkgd.min.js', array(), STOREPICTURE_VERSION, true);
		...
		/* Sortable */
		wp_register_script('Sortable', plugin_dir_url( STOREPICTURE_PLUGIN_FILE ) . 'assets/javascripts/Sortable.js', array('jquery'), STOREPICTURE_VERSION, true);
